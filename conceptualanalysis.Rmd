...
ggplot(phenbe, aes(x=forcats::fct_infreq(Site))) +
  geom_histogram(stat="count") +
  facet_grid(Sex ~ Side) +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) 

ggplot(phenbe, aes(x=forcats::fct_infreq(Provenance))) +
  geom_histogram(stat="count") +
  facet_grid(Sex ~ Side) +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) 

ggplot(phenbe, aes(x=forcats::fct_infreq(Year))) +
  geom_histogram(stat="count") +
  facet_grid(Sex ~ Side) +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) 

ggplot(phenbe, aes(x=forcats::fct_infreq(Clone))) +
  geom_histogram(stat="count") +
  facet_grid(Sex ~ Side) +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) 

ggplot(phenbe, aes(x = forcats::fct_infreq(interaction(Site, Year)))) +
  geom_histogram(stat="count") +
  facet_grid(Sex ~ Side) +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) 
...
If I include Site-Year, it will also need to have non-centering *within* factors - maybe cutoff around 50 or 60?
