...
For starting, values less than ~225 and greater than 750 would be surprising.
For finishing, values less than ~250 and greater than 1000 would be surprising.


$\mu \sim \mathcal{N}(500,150)$

Covers that entire range nicely.

```{r}
hist(rnorm(1000, 500, 150), breaks=60)
```
But smaller ranges specifically for start and end may be

$\mu \sim \mathcal{N}(300,100)$
$\mu \sim \mathcal{N}(500,100)$

```{r}
par(mfrow=c(2,1))

hist(rnorm(1000, 400, 50), breaks=30)
hist(rnorm(1000, 500, 50), breaks=30)
```
