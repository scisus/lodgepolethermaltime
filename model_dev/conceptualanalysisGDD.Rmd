...
- clone (individual tree)

and variation due to provenance climate summarised at MAT

So

$f_i = \mu + \beta MAT_i + delta_{site,i} + \delta_{year,i} + \delta_{genotype,i} + \delta_{clone,i}$
...
Each event is associated with a year, site, genotype, and clone. There are 14 years, 7 sites, 259 genotypes, and 748 individual trees (clones).
...
I've stuck with half normals because while genotype and clone have hundreds of levels, Site only has 7 and year only 14 (15?)
