// This is a stan program written by [Michael Betancourt](https://github.com/betanalpha/knitr_case_studies/blob/master/factor_modeling/stan_programs/construct_inter_idx_general.stan) to programmatically construct first and second-order factor level interactions. Factors must first be organized into a matrix. This stan program requires data like:
