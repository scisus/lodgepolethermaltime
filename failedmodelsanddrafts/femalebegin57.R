...
fdat <- filter_sex_event(sex = "FEMALE", event = "begin", phenf)
...
#
#
# ggplot(dat, aes(x = sum_forcing, y = Site, colour = Year)) +
#   geom_jitter(alpha = 0.5)
#
# ggplot(dat, aes(x = sum_forcing)) +
#   geom_density()
#
# ggplot(fdat, aes(x=sum_forcing)) +
#   geom_density()
