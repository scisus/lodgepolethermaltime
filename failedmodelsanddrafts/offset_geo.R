...
phenf$Geographic.Location[is.na(phenf$Geographic.Location)] <- "UNKNOWN"
...
# model formula
bform <- brmsformula(sum_forcing | cens(censored, upper) ~ 1 + (1|Site) + (1|Clone) + (1|Year) + (1|Tree) + (1|Geographic.Location))
