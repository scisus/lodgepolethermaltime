...
model {
  ...
  target += student_t_lpdf(sd_1 | 3,0,9)
    - 1 * student_t_lccdf(0 | 3,0,9);
  target += std_normal_lpdf(z_1[1]);
  target += student_t_lpdf(sd_2 | 3,0,9)
    - 1 * student_t_lccdf(0 | 3,0,9);
  target += std_normal_lpdf(z_2[1]);
  target += student_t_lpdf(sd_3 | 3,0,9)
    - 1 * student_t_lccdf(0 | 3,0,9);
  target += std_normal_lpdf(z_3[1]);
  target += student_t_lpdf(sd_4 | 3,0,9)
    - 1 * student_t_lccdf(0 | 3,0,9);
  target += std_normal_lpdf(z_4[1]);
  target += student_t_lpdf(sd_5 | 3,0,9)
    - 1 * student_t_lccdf(0 | 3,0,9);
...
generated quantities {
  ...
  real prior_sd_1 = student_t_rng(3,0,9);
  real prior_sd_2 = student_t_rng(3,0,9);
  real prior_sd_3 = student_t_rng(3,0,9);
  real prior_sd_4 = student_t_rng(3,0,9);
  real prior_sd_5 = student_t_rng(3,0,9);
  // use rejection sampling for truncated priors
  while (prior_sigma < 0) {
    prior_sigma = normal_rng(0,15);
  }
  while (prior_sd_1 < 0) {
    prior_sd_1 = student_t_rng(3,0,9);
  }
  while (prior_sd_2 < 0) {
    prior_sd_2 = student_t_rng(3,0,9);
  }
  while (prior_sd_3 < 0) {
    prior_sd_3 = student_t_rng(3,0,9);
  }
  while (prior_sd_4 < 0) {
    prior_sd_4 = student_t_rng(3,0,9);
  }
  while (prior_sd_5 < 0) {
    prior_sd_5 = student_t_rng(3,0,9);
  }
}
