...
simulate_from_model <- function(data, model, nlevels = 5, nsamples = 10, seed = 1013, cores = 6) {
  # retrodict "true"
...
simsum <- allsim %>%
    group_by(Sex, event, prediction_type) %>%
    median_hdci(prediction, .width = c(0.5, 0.89))
